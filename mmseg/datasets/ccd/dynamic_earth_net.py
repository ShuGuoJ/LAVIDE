...
@DATASETS.register_module()
class FasterDynamicEarthNetCCD(DynamicEarthNetCCD):
    '''
    DynamicEarthNet for Conditional CD.
    Inherits evaluate() from CustomDatasetCCD
    '''
    ...
    def prepare_train_img(self, idx):
        ...
        gt_semantic_seg_post, gt_semantic_seg_pre = self.loaded_anns[gt_semantic_seg_post_file], self.loaded_anns[gt_semantic_seg_pre_file]
